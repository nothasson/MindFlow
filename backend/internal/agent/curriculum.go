...
6. 使用中文
7. concept 字段必须是“真正的知识主题 / 概念名 / 技能点”，而不是任务句子、行动建议或完整指令
8. concept 应尽量是简洁名词短语，长度控制在 2 到 16 个字之间
9. 禁止把以下内容写进 concept：学习计划、首个计划、开始学习、先了解、探索一下、制定一个计划、选择一个方向、完成一节课、动手试试
10. 如果没有足够明确的概念，就返回空数组或 null，不要为了凑数编造动作建议
